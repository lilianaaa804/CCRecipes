...
<div id="article_wrapper">
	...
	<div id="article_main">
		...
		<div id="article_center">
			...
			<form action="${pageContext.request.contextPath}/article/article_write_process.do" method="post" enctype="multipart/form-data">
				<div id="article_head">
				...
				<div id="article_body">
					<div id="article_text"><textarea name="article_text" rows="10" cols="60"></textarea></div>
					<div id="article_imgupload"><input name="files" type="file" accept="image/*"  multiple="multiple"></div>
					...
					<div id="button_list">
						...
						<button class="btn_a write_a">글쓰기</button>
					</div>
				</div>
				</div>
