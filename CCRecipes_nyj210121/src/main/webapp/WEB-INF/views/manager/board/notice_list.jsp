	  ...
	  <div class="row">
		...
		<div class = "row">
			<div class = "col" style = "background-color: rgba(0,0,0, 0.4); height : 900px;">
                        ...
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                            <a class="nav-link active underline-on-hover" href="${pageContext.request.contextPath }/manager/board/notice_list.do">공지사항</a>
                            </li>
                            <li class="nav-item">
	      ...
	      <div class = "row mb-3">
	      	...
	      	<div class = "col-2">
	      		<select class = "form-select" >
	      			...
	      			<option name = "search" value = "crr_qna_date" >회원등급</option>
	      		</select>
	      	</div>
	      	<div class = "col-8	">
