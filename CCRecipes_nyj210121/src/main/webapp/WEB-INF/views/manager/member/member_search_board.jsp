...
<body class="ccrcontainer" >
	...
	<div class="qnacontainer">
	  <div class="row">
		...
		<div class = "row">
			<div class = "col" style = "background-color: rgba(0,0,0, 0.4); height : 700px;">
                        <h3 style = "color : white; ">Clear-Cut Recipes</h3>
                        
                        <p class = "white_text margin_b">회원 관리</p>
                          <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                            <a class="nav-link active underline-on-hover" href="${pageContext.request.contextPath }/manager/member/member_list.do">회원리스트</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <hr class="d-sm-none">
                         ...
                         <p class = "white_text margin_b">클래스 관리</p>
                          ...
                          <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                            <a class="nav-link underline-on-hover active" href="${pageContext.request.contextPath }/manager/megazine/megazine_list.do">매거진 리스트</a>
                            </li>
                            <li class="nav-item">
		...
		<form action = "${pageContext.request.contextPath }/manager/member/member_serach.do" method = "post">
	      <div class = "row mb-3">
	      			...
	      			<c:forEach items="${resultList}" var="data"> 
		      			...
		      			<div class = "row mb-2">
			      			...
			      			<div class = "col text_center_align"> 
			      				<div class = "row">
			      					<div class = "col"><button>수정</button></div>
			      					<div class = "col"><a href = "${pageContext.request.contextPath }/member/delete_member.do?member_no=${data.ccrMemberVo.member_no}"><button type = "button">삭제</button></a></div>
