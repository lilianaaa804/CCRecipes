...
<body class="ccrcontainer" >
	...
	<div class="qnacontainer">
	  <div class="row">
			...
			<div class = "col" style = "background-color: rgba(0,0,0, 0.4); height : 900px;">
                        ...
                        <hr class="d-sm-none">
                         ...
                         <p class = "white_text margin_b">서비스 관리</p>
                          <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                            <a class="nav-link active underline-on-hover" href="${pageContext.request.contextPath }/manager/service/coin_order.do">코인 구매내역</a>
                            </li>
                            <li class="nav-item">
	    ...
	    <div class="col-sm-8">
	      <p style = "margin-bottom:5px;">서비스 관리</p>
	      <h2>코인 구매내역</h2>
