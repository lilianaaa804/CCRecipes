	   ...
	   <jsp:include page="/WEB-INF/views/common/qnabar.jsp"></jsp:include>
	    ...
	    <div class="col-sm-8">
	      ...
	      <form action = "${pageContext.request.contextPath }/qna/qna_writing_process.do" method = "post">
		      ...
		      <div class="mb-2">
				  <input name = "qna_title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="제목을 입력해주세요.">
			  </div>
		      
		      <div class="mb-2">
				  <textarea name = "qna_text" class="form-control" id="exampleFormControlTextarea1" placeholder="내용을 입력해주세요." rows="15"></textarea>
			  </div>	
